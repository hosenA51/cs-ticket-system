...
const Banner = () => {
    return (
        ...
        bg-gradient-to-l from-purple-500 to-indigo-500 flex flex-col items-center justify-center">
                <div
            ...
            <div className="relative overflow-hidden rounded-xl h-32 md:h-36 lg:h-64 text-white 
        bg-gradient-to-r from-green-500 to-teal-600 flex flex-col items-center justify-center">
                <div
                    className="absolute inset-y-0 left-0 w-44 lg:w-80 opacity-100 pointer-events-none"
                    style={{
                        backgroundImage: `url(${vectorImg})`,
